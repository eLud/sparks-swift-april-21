...
let saladeCésar = Meal(name: "Salade césar", kind: .main, ingredients: [salade, poulet], price: 3.5, pitch: "Une salade verte", preciseDescription: "")
